...
def test_new_task_runner():
    ...
    g1 = TaskGroup('g1', g1_tasks, 'context', 'file1.ceryle', dependencies=['g2'])

    g2_tasks = [Task(Command('do b'))]
    g2 = TaskGroup('g2', g2_tasks, 'context', 'file1.ceryle', dependencies=[])
...
def test_raises_dependency_error():
    ...
    g2_tasks = [Task(Command('do b'))]
    g2 = TaskGroup('g2', g2_tasks, 'context', 'file1.ceryle', dependencies=['g3'])
    ...
    g3 = TaskGroup('g3', g3_tasks, 'context', 'file1.ceryle', dependencies=['g1'])
...
def test_get_run_cache_raises_before_runnin():
    g1 = TaskGroup('g1', [], 'context', 'file1.ceryle')
...
def test_run_task_not_defined_print_similar_tasks():
    g1 = TaskGroup('build-foo', [], 'context', 'file1.ceryle', dependencies=[])
    g2 = TaskGroup('build-bar', [], 'context', 'file1.ceryle', dependencies=[])
    g3 = TaskGroup('build-all', [], 'context', 'file1.ceryle', dependencies=[])
    g4 = TaskGroup('test-e2e', [], 'context', 'file1.ceryle', dependencies=[])
...
def test_run_skip_task_already_run(mocker):
    ...
    g1_t1 = Task(Command('do some'))
    g1 = TaskGroup('g1', [g1_t1], 'context', 'file1.ceryle', dependencies=['g2', 'g3'])

    g2_t1 = Task(Command('do some'))
    g2 = TaskGroup('g2', [g2_t1], 'context', 'file1.ceryle', dependencies=['g4'])

    g3_t1 = Task(Command('do some'))
    g3 = TaskGroup('g3', [g3_t1], 'context', 'file1.ceryle', dependencies=['g4'])

    g4_t1 = Task(Command('do some'))
    g4 = TaskGroup('g4', [g4_t1], 'context', 'file1.ceryle', dependencies=[])
    ...
    assert mock.mock_calls == [
        mocker.call.g4_t1_run('context', dry_run=False, inputs=[]),
        mocker.call.g2_t1_run('context', dry_run=False, inputs=[]),
        mocker.call.g3_t1_run('context', dry_run=False, inputs=[]),
        mocker.call.g1_t1_run('context', dry_run=False, inputs=[]),
    ]
...
def test_run_do_not_skip_if_not_allowed(mocker):
    ...
    g1_t1 = Task(Command('do some'))
    g1 = TaskGroup('g1', [g1_t1], 'context', 'file1.ceryle', dependencies=['g2', 'g3', 'g4', 'g4'])
    ...
    g4_t1 = Task(Command('do some'))
    g4 = TaskGroup('g4', [g4_t1], 'context', 'file1.ceryle', dependencies=[], allow_skip=False)
...
def test_run_skip_succeeded_tasks(mocker):
    ...
    g1_t1 = Task(Command('do some'))
    g1 = TaskGroup('g1', [g1_t1], 'context', 'file1.ceryle', dependencies=['g2'])

    g2_t1 = Task(Command('do some'))
    g2 = TaskGroup('g2', [g2_t1], 'context', 'file1.ceryle', dependencies=[])
...
def test_run_skip_succeeded_tasks_in_new_deps_tree(mocker):
    ...
    g1_t1 = Task(Command('do some'))
    g1 = TaskGroup('g1', [g1_t1], 'context', 'file1.ceryle', dependencies=['g3'])

    g3_t1 = Task(Command('do some'))
    g3 = TaskGroup('g3', [g3_t1], 'context', 'file1.ceryle', dependencies=['g2'])
